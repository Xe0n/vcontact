          ...
          <div className='border-b border-gray-900/10 pb-12'>
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input className='input input-bordered w-full max-w-xs' placeholder='bill' {...register('name')}/>
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input className='input input-bordered w-full max-w-xs' placeholder='bluebill1049@hotmail.com' type='email' {...register('email')}/>
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input className='input input-bordered w-full max-w-xs' placeholder='+998900610897' type='text' {...register('phone')}/>
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <select className='select select-bordered w-full max-w-xs' {...register('tag')} value={defTag} onChange={(e) => setDefTag(e.target.value)}>
                  {tags?.map((item) => (<option key={item.id} value={item.id}>
                      {item.attributes.tag}
                    </option>))}
                </select>
              </div>
