...
import { Person, TagsType, FormType } from '../types/types';
          ...
          <div className='border-b border-gray-900/10 pb-12'>
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input
                  ...
                  defaultValue={people.attributes.name}
                  placeholder='bill'
                  {...register('name')}
                />
              </div>
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input
                  className='input input-bordered w-full max-w-xs'
                  defaultValue={people.attributes.email}
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              <div className='sm:col-span-4'>
                ...
                <input
                  className='input input-bordered w-full max-w-xs'
                  defaultValue={people.attributes.phone}
                  placeholder='bluebill1049@hotmail.com'
                  type='phone'
                  {...register('phone')}
                />
